...
public class Bed extends ActivityBase{
	...
	//已选病害列表
	private ListView selected_error_listview_bed;
	...
	protected static final int BED_TAKEPHOTO = 2; // 拍照后
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.update_bed);
		try{
			Id = this.getIntent().getExtras().getString("id");
		}catch(Exception ex){}
		
		//加载头部
		header = new Header(this,"路基技术状况调查表",
	...
	public class HeaderLeftButtonOnClickListener implements OnClickListener{
		...
		public void onClick(View v) {
			Intent intent  = new Intent(Bed.this,com.road.check.app.CheckHistoricalRecordsDetail.class);
			Bundle bundle  = new Bundle();
			bundle.putString("id", Id);
			intent.putExtras(bundle);
			Bed.this.startActivity(intent);
			Bed.this.finish();
		}
	}
	/**头部右边按钮点击事件：保存*/
	...
	/**初始化*/
	public void init(){
		txt_round_name = (TextView)Bed.this.findViewById(R.id.txt_round_name);
		txt_roundid = (TextView)Bed.this.findViewById(R.id.txt_roundid);
		txt_direction = (TextView)Bed.this.findViewById(R.id.txt_direction);
		txt_time = (TextView)Bed.this.findViewById(R.id.txt_time);
		edt_chainage = (EditText)Bed.this.findViewById(R.id.edt_chainage);
		btn_error_type = (Button)Bed.this.findViewById(R.id.btn_error_type);
		selected_error_listview_bed = (ListView)Bed.this.findViewById(R.id.selected_error_listview);
		sp_degree = (Spinner)Bed.this.findViewById(R.id.sp_degree);
		edt_describe = (EditText)Bed.this.findViewById(R.id.edt_describe);
		edt_remark = (EditText)Bed.this.findViewById(R.id.edt_remark);
		btn_error_photo = (Button)Bed.this.findViewById(R.id.btn_error_photo);
		error_photo_listview = (ListView)Bed.this.findViewById(R.id.error_photo_listview);
    	...
    	selectedAdapter = new SelectedErrorAdapter(Bed.this, selectedContentList);
    	selected_error_listview_bed.setAdapter(selectedAdapter);
    	selected_error_listview_bed.setOnItemClickListener(new OnItemClickListener() {
			@Override
			public void onItemClick(AdapterView<?> arg0, View arg1, final int position,
					long arg3) {
				AlertDialog.Builder ad = new AlertDialog.Builder(Bed.this);
				ad.setTitle("删除提示");
				...
				ad.setPositiveButton("确定", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						selectedAdapter.setListViewHeightBasedOnChildren(selected_error_listview_bed);
    	...
    	error_degree_adapter = new ArrayAdapter<String>(Bed.this,android.R.layout.simple_spinner_item,error_degree_list);
    	...
    	photoAdapter = new PhotoAdapter(Bed.this, photo_url_list);
    	...
    	error_photo_listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				LayoutInflater inflater = Bed.this.getLayoutInflater();
				...
				rBigImgAdapter = new RBigImgAdapter(Bed.this, imgFilePathList);
				...
				gallery_bigimg.setOnItemLongClickListener(new OnItemLongClickListener() {
					...
					public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
						...
						AlertDialog.Builder ab = new AlertDialog.Builder(Bed.this);
						ab.setTitle("温馨提示");
				...
				pw_bigimg.showAtLocation(Bed.this.getWindow().findViewById(Window.ID_ANDROID_CONTENT), Gravity.CENTER, 0, 0);
			}
		});
	...
	class ErrorSelecte implements OnClickListener{
		...
		public void onClick(View v) {
			if(selectedContentList.size() > 0){
				AlertDialog.Builder e_ab = new AlertDialog.Builder(Bed.this);
				e_ab.setTitle("温馨提示");
			...
			View diaView = View.inflate(Bed.this, R.layout.report_create_module_errorselecte_dialog, null);
			...
			errorAdapter = new ErrorAdapter(Bed.this, errorlist);
			...
			errorselecteDialog = new Dialog(Bed.this,R.style.dialog);
	...
	class PhotoAdapter extends ArrayAdapter<String>{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			ViewCache viewCache;
			if(rowView == null){
				rowView = Bed.this.getLayoutInflater().inflate(R.layout.report_create_module_roadbed_photo_list_item, null);
    ...
    public class PhotoImgButtonOnClickListener implements OnClickListener{
		...
		public void onClick(View v) {
			if(selectedContentList.size() <= 0){
				Toast.makeText(Bed.this, "请先选择病害类型！", Toast.LENGTH_SHORT).show();
				return;
			}
			...
			try {
				...
				Bed.this.startActivityForResult(intent, BED_TAKEPHOTO);
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
    ...
    class SavaDatasTask extends AsyncTask<String, String, String>{
		...
		protected void onPostExecute(String result) {
			if(result.equals("-1")){
				Toast.makeText(Bed.this, "请选择病害程度！", Toast.LENGTH_SHORT).show();
				return;
			}
			
			Toast.makeText(Bed.this, "保存成功！", Toast.LENGTH_SHORT).show();
