...
public List<Node> childrens = new ArrayList<Node>();//子节点
public String title;//节点显示文字
public String value;//节点显示值
public int icon = -1; //icon(R.drawable的id)
public boolean isChecked = false; //是否被选中
public boolean isExpand = false;//是否处于扩展状态
public boolean hasCheckBox = true;//是否有复选框
